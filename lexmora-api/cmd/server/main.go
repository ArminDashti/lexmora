...
func main() {
	...
	h := handler.New(authService, transformService, historyService, statsService, settingsService, instructionService, quizService, openRouter)
